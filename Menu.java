...
public class Menu {
    ...
    private void menuConsultar() {
        boolean regresar = false;
        while (!regresar) {
            String[] opciones = {"Consultar Eventos", "Consultar Información y Resultados", "Consultar Participantes", "Consultar Clasificación", "Regresar"};
            int seleccion = JOptionPane.showOptionDialog(
                    null,
                    "Seleccione una opción de consulta:",
                    "Menú de Consultas",
            ...
            switch (seleccion) {
                ...
                case 2: // Consultar Participantes
                    ...
                    break;
                case 3:
                    //consultarClasificacion(); ++++++Agregar+++++++
                    break;
                case 4: // Regresar
                    regresar = true;
                    break;
    ...
    private void modificarPartidos(Evento evento) {
        boolean regresar = false;
        while (!regresar) {
            String[] opciones = {"Añadir Partido", "Modificar Codigo del Partido","Modificar Resultado del Partido", "Modificar Fecha del Partido","Eliminar Partido", "Listar Partidos", "Regresar"};
            int seleccion = JOptionPane.showOptionDialog(
                null,
    ...
    */
    ...
    private void consultarResultados() { // ++++++++++++++++++++++++ARREGLAR++++++++++++++++++++++
        pilaResultados.listarResultados();
    }
